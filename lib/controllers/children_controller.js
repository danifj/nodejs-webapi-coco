...
let setActiveChild = (req, res, next) => {
    ...
    let data = req.body;
    let id = req.params.id;
    let child = new Child(id, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, data.active);
    let childrenRepo = new ChildrenRepository(connection);

    childrenRepo.setActiveChild(child, result => {
        res.send('Update success data');
        next();
    }, err => {
        if(err){
