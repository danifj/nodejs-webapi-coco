...
let saveChild = (req, res, next) => {
    ...
    let data = req.body;
    let child = new Child(data.id, data.firstName, data.lastName, data.age, data.birthdate, data.diseases, data.allergies, data.dni, data.phone1, data.phone2, data.phone3, data.street, data.streetNumber, data.floor, data.department, data.neighborhood, data.city, data.fatherFirstName, data.fatherLastName, data.fatherEmail, data.motherFirstName, data.motherLastName, data.motherEmail, data.roomId, data.turnId, data.authorizedPersons);
