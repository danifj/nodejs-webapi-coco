...
let saveNonattendance = (req, res, next) => {
    ...
    let data = req.body;
    let nonattendance = new Nonattendance(data.childrenId, data.nonattendanceTypeId);
...
let updateNonattendance = (req, res, next) => {
    ...
    let nonattendance = new Nonattendance(id, data.childrenId, data.nonattendanceTypeId);
    let nonattendanceRepo = new NonattendanceRepository(connection);
...
let getNonattendances = (req, res, next) => {

    handleDisconnect();

    let nonattendanceRepo = new NonattendanceRepository(connection);
    nonattendanceRepo.findAll(result => {
...
module.exports = {
  ...
  getNonattendances: getNonattendances
};