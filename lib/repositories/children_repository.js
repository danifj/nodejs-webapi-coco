...
ChildrenRepository.prototype = {
  save: function (e, cb, errCb) {
      ...
      let db = this.db;
      let data = [e.firstName,e.lastName,e.age,e.birthdate,e.dni,e.diseases,e.allergies,e.phone1,e.phone2,e.phone3,e.street,e.streetNumber,e.floor,e.department,e.neighborhood,e.city,e.fatherFirstName,e.fatherLastName,e.motherFirstName,e.motherLastName,e.roomId,e.turnId,e.authorizedPersons];
