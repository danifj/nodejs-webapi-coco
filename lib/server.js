...
let totalCountableController = require('./controllers/totalCountable_controller');
...
app.put('/child/active/:id', childrenController.setActiveChild); //For update
app.put('/child/authorizedpersons/:id', childrenController.setAuthorizedPersonsByChildId); //For update
app.delete('/child/:id', childrenController.deleteChildById); //For delete
...
app.put('/itemquota/values', itemQuotaController.setValuesItemsQuota); //For update
...
app.post('/itemquota/monstart/childitemquota', itemQuotaController.setMonthlyStartChildrenQuotaItems); //For save
app.post('/itemquota/monstart/valueitemquota', itemQuotaController.setMonthlyStartValuesQuotaItems); //For save

app.get('/debtors', debtorController.getDebtors); //For get

app.get('/totalcountable', totalCountableController.getTotalCountable); //For get
